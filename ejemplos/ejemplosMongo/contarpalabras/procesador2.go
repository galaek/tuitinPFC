...
func InterestsTesting () {
	...
	profiles.GetTimelineToDB(*c, twitterProfile, 500) 
	...
	fmt.Println(profiles.TopicsList)
	fmt.Println("Here")
	//fmt.Println(profiles.TopicsDB)
	...
	cinema := 0;
	for i:=0; i<len(listaPalabras); i++ {
		value, exists := profiles.Topics_football[listaPalabras[i].Word]
		if exists == true {
			football = football + (listaPalabras[i].Value * value)
			fmt.Println(listaPalabras[i].Word, listaPalabras[i].Value )
		}
		value, exists = profiles.Topics_basket[listaPalabras[i].Word]
		if exists == true {
			basket = basket + (listaPalabras[i].Value * value)
			fmt.Println(listaPalabras[i].Word, listaPalabras[i].Value)
		}
		value, exists = profiles.Topics_cycling[listaPalabras[i].Word]
		if exists == true {
			cycling = cycling + (listaPalabras[i].Value * value)
			fmt.Println(listaPalabras[i].Word, listaPalabras[i].Value)
		}
		value, exists = profiles.Topics_tenis[listaPalabras[i].Word]
		if exists == true {
			tenis = tenis + (listaPalabras[i].Value * value)
			fmt.Println(listaPalabras[i].Word, listaPalabras[i].Value)
		}
		value, exists = profiles.Topics_racing[listaPalabras[i].Word]
		if exists == true {
			racing = racing + (listaPalabras[i].Value * value)
			fmt.Println(listaPalabras[i].Word, listaPalabras[i].Value)
		}
		value, exists = profiles.Topics_sports[listaPalabras[i].Word]
		if exists == true {
			sports = sports + (listaPalabras[i].Value * value)
			fmt.Println(listaPalabras[i].Word, listaPalabras[i].Value)
		}
		value, exists = profiles.Topics_esports[listaPalabras[i].Word]
		if exists == true {
			esports = esports + (listaPalabras[i].Value * value)
			fmt.Println(listaPalabras[i].Word, listaPalabras[i].Value)
		}
		value, exists = profiles.Topics_music[listaPalabras[i].Word]
		if exists == true {
			music = music + (listaPalabras[i].Value * value)
			fmt.Println(listaPalabras[i].Word, listaPalabras[i].Value)
		}
		value, exists = profiles.Topics_technology[listaPalabras[i].Word]
		if exists == true {
			technology = technology + (listaPalabras[i].Value * value)
			fmt.Println(listaPalabras[i].Word, listaPalabras[i].Value)
		}
		value, exists = profiles.Topics_animals[listaPalabras[i].Word]
		if exists == true {
			animals = animals + (listaPalabras[i].Value * value)
			fmt.Println(listaPalabras[i].Word, listaPalabras[i].Value)
		}
		value, exists = profiles.Topics_nature[listaPalabras[i].Word]
		if exists == true {
			nature = nature + (listaPalabras[i].Value * value)
			fmt.Println(listaPalabras[i].Word, listaPalabras[i].Value)
		}
		value, exists = profiles.Topics_arts[listaPalabras[i].Word]
		if exists == true {
			arts = arts + (listaPalabras[i].Value * value)
			fmt.Println(listaPalabras[i].Word, listaPalabras[i].Value)
		}
		value, exists = profiles.Topics_cinema[listaPalabras[i].Word]
		if exists == true {
			cinema = cinema + (listaPalabras[i].Value * value)
			fmt.Println(listaPalabras[i].Word, listaPalabras[i].Value)
		}

	}
	for i:=0; i<len(listaDoblesPalabras); i++ {
		value, exists := profiles.Topics_football[listaDoblesPalabras[i].Word]
		if exists == true {
			football = football + (listaDoblesPalabras[i].Value * value)
			fmt.Println(listaDoblesPalabras[i].Word, listaDoblesPalabras[i].Value)
		}
		value, exists = profiles.Topics_basket[listaDoblesPalabras[i].Word]
		if exists == true {
			basket = basket + (listaDoblesPalabras[i].Value * value)
			fmt.Println(listaDoblesPalabras[i].Word, listaDoblesPalabras[i].Value)
		}
		value, exists = profiles.Topics_cycling[listaDoblesPalabras[i].Word]
		if exists == true {
			cycling = cycling + (listaDoblesPalabras[i].Value * value)
			fmt.Println(listaDoblesPalabras[i].Word, listaDoblesPalabras[i].Value)
		}
		value, exists = profiles.Topics_tenis[listaDoblesPalabras[i].Word]
		if exists == true {
			tenis = tenis + (listaDoblesPalabras[i].Value * value)
			fmt.Println(listaDoblesPalabras[i].Word, listaDoblesPalabras[i].Value)
		}
		value, exists = profiles.Topics_racing[listaDoblesPalabras[i].Word]
		if exists == true {
			racing = racing + (listaDoblesPalabras[i].Value * value)
			fmt.Println(listaDoblesPalabras[i].Word, listaDoblesPalabras[i].Value)
		}
		value, exists = profiles.Topics_sports[listaDoblesPalabras[i].Word]
		if exists == true {
			sports = sports + (listaDoblesPalabras[i].Value * value)
			fmt.Println(listaDoblesPalabras[i].Word, listaDoblesPalabras[i].Value)
		}
		value, exists = profiles.Topics_esports[listaDoblesPalabras[i].Word]
		if exists == true {
			esports = esports + (listaDoblesPalabras[i].Value * value)
			fmt.Println(listaDoblesPalabras[i].Word, listaDoblesPalabras[i].Value)
		}
		value, exists = profiles.Topics_music[listaDoblesPalabras[i].Word]
		if exists == true {
			music = music + (listaDoblesPalabras[i].Value * value)
			fmt.Println(listaDoblesPalabras[i].Word, listaDoblesPalabras[i].Value)
		}
		value, exists = profiles.Topics_technology[listaDoblesPalabras[i].Word]
		if exists == true {
			technology = technology + (listaDoblesPalabras[i].Value * value)
			fmt.Println(listaDoblesPalabras[i].Word, listaDoblesPalabras[i].Value)
		}
		value, exists = profiles.Topics_animals[listaDoblesPalabras[i].Word]
		if exists == true {
			animals = animals + (listaDoblesPalabras[i].Value * value)
			fmt.Println(listaDoblesPalabras[i].Word, listaDoblesPalabras[i].Value)
		}
		value, exists = profiles.Topics_nature[listaDoblesPalabras[i].Word]
		if exists == true {
			nature = nature + (listaDoblesPalabras[i].Value * value)
			fmt.Println(listaDoblesPalabras[i].Word, listaDoblesPalabras[i].Value)
		}
		value, exists = profiles.Topics_arts[listaDoblesPalabras[i].Word]
		if exists == true {
			arts = arts + (listaDoblesPalabras[i].Value * value)
			fmt.Println(listaDoblesPalabras[i].Word, listaDoblesPalabras[i].Value)
		}
		value, exists = profiles.Topics_cinema[listaDoblesPalabras[i].Word]
		if exists == true {
			cinema = cinema + (listaDoblesPalabras[i].Value * value)
			fmt.Println(listaDoblesPalabras[i].Word, listaDoblesPalabras[i].Value)
		}
	...
	fmt.Println("cycling:", cycling)
	fmt.Println("tennis:", tenis)
	fmt.Println("racing", racing)
	fmt.Println("sports:", sports)
	fmt.Println("e-sports:", esports)
	fmt.Println("music:", music)
	fmt.Println("technology:", technology)
	fmt.Println("animals:", animals)
	fmt.Println("nature:", nature)
	fmt.Println("arts:", arts)
	fmt.Println("cinema:", cinema)
	err = c.DropCollection()
	if err != nil { 
		panic(err) 
	}	
...
func RtAndFavTesting () {
	...
	for i:=0; i<5; i++ {
		fmt.Println("Rt", i, "=", top.MostRt[i].Retweet_count)
		fmt.Println("ID", i, "=", top.MostRt[i].Retweeted_status.Id)
		fmt.Println("Texto:", top.MostRt[i].Text)
	}
	for i:=0; i<5; i++ {
		fmt.Println("Fav", i, "=", top.MostFav[i].Favorite_count)
...
func DataBaseTestAndParsing () {
	...
	listaPalabrasKeyword = trendings.ParseTweetsKeyword(todosLosTweets, "ramos", "#championstve")
