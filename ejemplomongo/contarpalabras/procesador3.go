...
func RtAndFavTesting () {
	...
	a := session.DB("twitter").C("finalcopafixed")
...
func DataBaseTestAndParsing () {
	...
	listaPalabras, listaDoblesPalabras = trendings.ParseTweetsAll(todosLosTweets, "#FinalCopa")
	...
	listaPalabrasKeyword, listaDoblesPalabrasKeyword = trendings.ParseTweetsKeyword(todosLosTweets, "madrid", "#FinalCopa")
	...
	start, err := time.Parse(time.RubyDate, "Wed Apr 16 18:30:00 +0000 2014")
	end, err := time.Parse(time.RubyDate,"Wed Apr 16 18:45:00 +0000 2014")
	...
	// }
	listaPalabrasRango1, listaDoblesPalabrasRango1 = trendings.ParseTweetsAll(tweetsFiltrados, "#FinalCopa")
	...
	// for i:=0; i<len(tweetsFiltrados); i++ {
		// fmt.Println(i, tweetsFiltrados[i].Epoch, tweetsFiltrados[i].Created_at)
	// }
	listaPalabrasRango2, listaDoblesPalabrasRango2 = trendings.ParseTweetsAll(tweetsFiltrados, "#FinalCopa")
