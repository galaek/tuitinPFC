...
var (
	maxCt          *int    = flag.Int("maxct", 320000000, "Max # of messages")
	...
	search         *string = flag.String("search", "#Casillas", "keywords to search for, comma delimtted")
...
func main() {
	...
	c := session.DB("reprobando").C("casillas")
